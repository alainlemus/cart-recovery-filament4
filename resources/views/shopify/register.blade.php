...
<head>
    ...
    <title>Register for {{ $product->name }} - {{ config('app.name') }}</title>
    ...
    <div class="w-full max-w-md px-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-6 bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-center">
                ...
                <p class="text-sm mt-2 opacity-90">Subscribe to {{ $product->name }}</p>
                <p class="text-lg font-semibold mt-1">${{ number_format($product->price, 2) }}/month</p>
            </div>
        ...
        <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <h3 class="text-sm font-semibold text-blue-900 dark:text-blue-200 mb-2">What happens next?</h3>
            <ol class="text-sm text-blue-800 dark:text-blue-300 space-y-1 list-decimal list-inside">
                <li>Create your account</li>
                <li>Connect your Shopify store (OAuth)</li>
                <li>Approve the subscription charge</li>
                <li>Start recovering abandoned carts!</li>
            </ol>
        </div>
    </div>
</body>
